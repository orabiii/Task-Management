        ...
        <Modal bind:showModal bind:this={modal}>
            <div class="relative py-1 px-16 bg-white shadow-md rounded border border-neutral-950">
                <div class=" mb-4 w-full flex justify-start text-green-400">
                    ...
                    <h1 class="text-gray-800 font-lg text-xl font-bold tracking-normal leading-tight mt-1 ml-2">
                        Create Task
                    </h1>
                </div>
                ...
                <div class="relative mb-2 mt-2">
                    ...
                    <div class="flex items-center justify-start w-full">
                        <button on:click={()=> add_task()}
                            ...
                            duration-150 ease-in-out  rounded text-white px-8 py-2 text-sm
                            mr-1 {category.length == 0 || title.length == 0 ? 'bg-indigo-300 hover:bg-indigo-300' : 'bg-indigo-600 hover:bg-indigo-700'}"
                            disabled={category.length == 0 || title.length == 0} >Submit</button>
