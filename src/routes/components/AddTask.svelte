...
<body>
    ...
    <div class="flex flex-col items-center h-[10vh] m-4">
            <button class="group rounded-2xl h-12 w-48 bg-green-500 font-bold text-lg text-white relative overflow-hidden" on:click={()=> (showModal = true)}>
            Create Task !
            <div
            ...
            <Modal bind:showModal bind:this={modal}>
                <div class="relative py-1 px-16 bg-white shadow-md rounded border border-neutral-950">
                    ...
                    <input id="category" bind:value={category}
                        class="mb-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Required"/>
                    <label for="title"
                    ...
                    <input id="description" bind:value={description}
                        class="mb-2 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Optional"/>
  ...
  >
                    ...
                    <button on:click={() => modal.close()}
                            class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 transition duration-150 ease-in-out hover:bg-red-600 bg-red-700 rounded text-white px-8 py-2 text-sm">Cancel</button>
